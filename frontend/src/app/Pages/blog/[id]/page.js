        ...
        <div style={{ fontFamily: 'Arial, sans-serif', backgroundColor: '#f9f9f9', padding: '20px', maxWidth: '1200px', margin: '0 auto' }}>
            <div style={{ backgroundColor: '#fff', padding: '20px', borderRadius: '10px', boxShadow: '0 4px 8px rgba(0,0,0,0.1)' }}>
                ...
                <div style={{ marginBottom: '30px' }}>
                    <img
                        src={`${serverURL}/uploads/blogs/${blog?.blogImage}`} // Assuming image path is relative to public directory
                        alt={blog.blogTitle}
                        width={800}
                        height={400}
                        layout="responsive"
                ...
                <div
                    ...
                    dangerouslySetInnerHTML={{ __html: blog.description }} // Rendering HTML content safely
                />
