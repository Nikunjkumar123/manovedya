    ...
    return (
        <>
            ...
            <div className="bread">
                ...
                <div className="links">
                    <Link to="/all-flover" className="add-new">Back <i className="fa-regular fa-circle-left"></i></Link>
                </div>
            </div>
            ...
            <div className="d-form">
                <form className="row g-3" onSubmit={handleSubmit}>
                    <div className="col-md-6">
                        <label htmlFor="floverName" className="form-label">Flover Name</label>
                        <input
                            type="text"
                    ...
                    <div className="col-12 text-center">
                        <button type="submit" disabled={isLoading} className={`${isLoading ? 'not-allowed' : 'allowed'}`}>
                            {isLoading ? "Please Wait..." : "Add Flover"} {/* Updated button text */}
                        </button>
                    </div>
                </form>
            </div>
