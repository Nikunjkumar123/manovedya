...
const EditRefrenceCompany = () => {
    ...
    useEffect(() => {
        const fetchRefCompany = async () => {
            try {
                ...
                toast.error(error.response ? error.response.data.message : 'Error fetching reference company data');
            }
        };
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            toast.error(error.response ? error.response.data.message : 'Error updating reference company');
        } finally {
    ...
    return (
        <>
            ...
            <div className="bread">
                ...
                <div className="links">
                    <Link to="/all-ref-companies" className="add-new">Back <i className="fa-regular fa-circle-left"></i></Link>
                </div>
            </div>
            ...
            <div className="d-form">
                <form className="row g-3" onSubmit={handleSubmit}>
                    <div className="col-md-4">
                        <label htmlFor="refCompanyName" className="form-label">Reference Company Name</label>
                        <input
                            type="text"
                            name="refCompanyName"
