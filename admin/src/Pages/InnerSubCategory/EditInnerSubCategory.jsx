...
const EditInnerSubCategory = () => {
    ...
    const filterSubCategories = (categoryId) => {
        ...
        const filtered = subCategories.filter(subcategory => subcategory.categoryName._id === categoryId);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            toast.error(error.response?.data?.message || "Error updating inner subcategory");
    ...
    return (
        <>
            ...
            <div className="bread">
                ...
                <div className="links">
                    <Link to="/all-inner-subcategory" className="add-new">Back <i className="fa-regular fa-circle-left"></i></Link>
                </div>
            </div>
            ...
            <div className="d-form">
                <form className="row g-3" onSubmit={handleSubmit}>
                    ...
                    <div className="col-md-6">
                        <label htmlFor="subcategoryName" className="form-label">Select Subcategory</label>
                        <select
                    ...
                    <div className="col-md-6">
                        <label htmlFor="innerSubcategoryName" className="form-label">Inner Subcategory Name</label>
                        <input
                            type="text"
                    ...
                    <div className="col-md-6">
                        <label htmlFor="Image" className="form-label">Subcategory Image</label>
                        <input
                            type="file"
                            name='Image'
                            className="form-control"
