...
const AddShopBanner = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        setIsLoading(true);
        try {
            const response = await axios.post('http://localhost:8000/api/send-sale', data, { responseType: 'blob' });
        ...
        <>
            ...
            <div className="d-form">
                <form className="row g-3" onSubmit={handleSubmit}>
                    ...
                    <div className="col-md-6">
                        <label htmlFor="services" className="form-label">Services (comma-separated)</label>
                        <input
                            type="text"
                            className="form-control"
                            id="services"
                    ...
                    <div className="col-md-6">
                        <label htmlFor="reciveAmount" className="form-label">Receive Amount</label>
                        <input
                            type="text"
                            className="form-control"
                            id="reciveAmount"
